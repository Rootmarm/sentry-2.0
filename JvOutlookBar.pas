...
begin
  ...
  case Pages[PageIndex].ButtonSize of
    ...
    olbsSmall:
      if SmallImages <> nil then
      begin
        Result := Rect(0, 0, SmallImages.Width + Canvas.TextWidth(Pages[PageIndex].Buttons[ButtonIndex].Caption) + 200,
          H);
// Sentinel: This enables the area of the buttons to become wider
